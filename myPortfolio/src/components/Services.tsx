    ...
    <section className="container mx-auto my-12 max-w-4xl p-4">
      <div className="p-4 text-center">
        ...
        <h2 className="mb-2 font-bold text-blue-900">
          <span className="mr-2 font-headline text-3xl"></span>
          <span className="font-handwriting text-4xl"></span>
        </h2>
      ...
      <div className="mt-6 flex flex-col gap-2 md:flex-row justify-center ">
        {services.map((service, index) => (
          <div
            className="basis-1/3 rounded-lg bg-gradient-to-tr from-black to-gray-700 p-4 text-white cursor-pointer transition-shadow hover:shadow-2xl"
            key={index}>
